...
subroutine Format_Local_Global_ZMUMPS &
   ...
   complex( kind(0d0) ), intent(in) :: LocalMatrix( Shape_Element, Shape_Element, Number_Element )
  
   complex( kind(0d0) ), intent(out) :: GlobalMatrix( Number_Node, Number_Node_InOneLow )
   ...
   !==================================================================
   write(*,*)'         call Format_Local_Global_ZMUMPS'
   !==================================================================
   ...
   !==============================================================================================
            ...
            do j= 1, Shape_Element
             ...
             591   if( J_GlobalMatrix( Node_Element( i, e ), Counter_J )==Node_Element( j, e ) .and. & 
                  ...
                  if( Counter_J > Number_Node_InOneLow )then
                     ...
                     call Output_Error( 'Format_Local_Global_ZMUMPS', 70 )
                  end if
      ...
      if( Flag_Symmetric==Flag_On )then  
         ...
         call Output_Error( 'Format_Local_Global_ZMUMPS', 106 )
      end if
         ...
         do j= 1, Number_Node_InOneLow -1
            if( J_GlobalMatrix( i, j )/=0 .and. J_GlobalMatrix( i, j+1 )/=0 )then
               if( J_GlobalMatrix( i, j ) > J_GlobalMatrix( i, j+1 ) )then
                  ...
                  call Output_Error( 'Format_Local_Global_ZMUMPS', 113)
               end if
            end if
         end do
      end do
   ...
   !==============================================================================================
               ...
               do j= 1, Shape_Element
                ...
                691   if( J_GlobalMatrix( Node_Element( i, e ), Counter_J )==Node_Element( j, e ) .and. & 
                     ...
                     if( Counter_J > Number_Node_InOneLow )then
                        ...
                        call Output_Error( 'Format_Local_Global_ZMUMPS', 179 )
                     end if
                     if( Counter_J > Counter_J_MAX )then
                        Counter_J_MAX= Counter_J
                     end if
      ...
      if( Flag_Symmetric==Flag_On )then  
         ...
         call Output_Error( 'Format_Local_Global_ZMUMPS', 215 )
      end if
      ...
      do i= 1, Number_Node 
         do j= 1, Number_Node_InOneLow -1
            if( J_GlobalMatrix( i, j )/=0 .and. J_GlobalMatrix( i, j+1 )/=0 )then
               if( J_GlobalMatrix( i, j ) > J_GlobalMatrix( i, j+1 ) )then
                  write(*,*)'ERROR:  J_GlobalMatrix( i, j ) > J_GlobalMatrix( i, j+1 )'
                  call Output_Error( 'Format_Local_Global_ZMUMPS', 246 )
               end if
            end if
         end do
      end do
   ...
   !==============================================================================================
      ...
      call Output_Error( 'Format_Local_Global_ZMUMPS', 253 )
   end if


  
   return
end subroutine Format_Local_Global_ZMUMPS 
