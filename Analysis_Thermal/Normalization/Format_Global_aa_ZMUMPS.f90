...
subroutine Format_Global_aa_ZMUMPS &
   ...
   complex(kind(0d0)), intent(in) :: GlobalMatrix( Number_Node, Number_Node_InOneLow )
   integer, intent(inout) :: J_GlobalMatrix( Number_Node, Number_Node_InOneLow )
  
   complex(kind(0d0)), intent(out) :: aa_zmumps( Number_NonZero )
   integer, intent(out) :: ia_zmumps( Number_NonZero ), ja_zmumps( Number_NonZero )

   !====================================================================================
   write(*,*)'      call Format_Global_aa_ZMUMPS'
   !====================================================================================
...
!               write(*,*)'Format_Global_aa_ZMUMPS.f90 31 '
!               !stop
!            end if
!            end if
!         end if
...
!   end do
   ...
   !====================================================================================
            ...
            if( 0 < J_GlobalMatrix( i, j ) .and. J_GlobalMatrix( i, j ) <= Number_Node )then
               if( i >= J_GlobalMatrix( i, j ) )then ! Symmetric
                  ...
                  if( Counter_NonZero > Number_NonZero )then
                     ...
                     write(*,*)'Format_Global_aa_ZMUMPS.f90 65'
                     stop
                  end if
      ...
      if( Counter_NonZero /= Number_NonZero)then
         ...
         write(*,*)'Format_Global_aa_ZMUMPS.f90 59 '
         stop
      end if
      ...
      do i= 1, Number_NonZero
         if( ja_zmumps( i ) <= 0 )then
            ...
            write(*,*)' ja_zmumps( i ) <= 0 '
            write(*,*)'Format_Global_aa_ZMUMPS.f90 67 '
            stop
         end if       
         if( Number_Node < ja_zmumps( i )   )then  
    
            write(*,*)' Number_Node < ja_zmumps( i )  '
            write(*,*)'Format_Global_aa_ZMUMPS.f90 73 '
            stop
   ...
   !====================================================================================
            ...
            if( 0 < J_GlobalMatrix( i, j ) .and. J_GlobalMatrix( i, j ) <= Number_Node )then
               !if( i >= J_GlobalMatrix( i, j ) )then ! Symmetric
                  ...
                  if( Counter_NonZero > Number_NonZero )then
                     write(*,*)'ERROR :Counter_NonZero=' ,Counter_NonZero, '>', & 
                           'Number_NonZero', Number_NonZero
                     write(*,*)'Format_Global_aa_ZMUMPS.f90 119'
                     stop
                  end if
      ...
      if( Counter_NonZero /= Number_NonZero)then
         ...
         write(*,*)'Format_Global_aa_ZMUMPS.f90 113 '
         stop
      end if
      ...
      do i= 1, Number_NonZero
         if( ja_zmumps( i ) <= 0 )then
            ...
            write(*,*)'Format_Global_aa_ZMUMPS.f90 121 '
            stop
         end if       
         if( Number_Node < ja_zmumps( i )   )then  
            ...
            write(*,*)' Number_NonZero=', Number_NonZero
            write(*,*)' i=', i 
            write(*,*)'Format_Global_aa_ZMUMPS.f90 127 '
            stop
   ...
   !====================================================================================
      ...
      write(*,*)'Format_Global_aa_ZMUMPS.f90 82 '
      stop
   end if

   !====================================================================================
   write(*,*)'      end Format_Global_aa_ZMUMPS'
   !====================================================================================

   return
end subroutine Format_Global_aa_ZMUMPS  
