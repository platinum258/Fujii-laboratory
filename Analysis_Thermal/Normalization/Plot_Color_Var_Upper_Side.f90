...
subroutine Plot_Color_Var_Upper_Side & 
   ...
   do i= 1, 2
      Width_Var( i )= Position_Maximum_Color_Var( i, 1, 2 ) -Position_Maximum_Color_Var( i, 1, 1 )
   end do
   ...
   do i= 1, Number_Color_Level
      ...
      = ( Position_Maximum_Color_Var( 1, 1, 2 ) -Position_Maximum_Color_Var( 1, 1, 1 ) )/dble( Number_Color_Level ) *dble( i-1 ) &
         +Position_Maximum_Color_Var( 1, 1, 1 )  
      Position_Boundary_Level( 2, i ) & 
      = ( Position_Maximum_Color_Var( 1, 1, 2 ) -Position_Maximum_Color_Var( 1, 1, 1 ) )/dble( Number_Color_Level ) *dble( i ) &
         +Position_Maximum_Color_Var( 1, 1, 1 )  
   end do
   ...
   do i= 1, Number_Color_Level 
      do j= 1, 2
         do k= 1, 2
            Position_Color_Var_Level( 1, k, j, i )= Position_Boundary_Level( k, i )
            Position_Color_Var_Level( 2, k, j, i )= Position_Maximum_Color_Var( 2, j, 1 ) 
         end do
      end do
   end do
   ...
   write( File_Number, * ) Position_Maximum_Color_Var( 1, 1, 1 ) -118d0, &
                   Position_Maximum_Color_Var( 2, 1, 1 ) +2d0, 'moveto'
   write( File_Number, 73 )'(', Minimum_Value_Plotted, ') show'
   !write( File_Number, * ) Minimum_Value_Plotted 

   write( File_Number, * ) Position_Maximum_Color_Var( 1, 1, 2 ) -30d0, &
                   Position_Maximum_Color_Var( 2, 1, 1 ) +2d0, 'moveto'
   ...
   return
end subroutine Plot_Color_Var_Upper_Side
