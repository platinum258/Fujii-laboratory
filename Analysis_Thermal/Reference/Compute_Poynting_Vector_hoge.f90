...
subroutine Compute_Poynting_Vector&
       ( Number_PV, Position_PV, Element_Number_PV, Length_Maximum_Vector, &
         Number_Node, Position_Node, Value_Plot_TM, &
...
subroutine Compute_Poynting_Vector &
   ...
   if( Shape_Element==3 )then
      ...
      call Output_Error( 'Compute_Poynting_Vector', 127 )
   end if
...
!   write(100001,*)'hoge'
   ...
   if( Number_Element_on_Boundary_1/=Number_Element_on_Boundary_2 )then
      call Output_Error( 'Compute_Poynting_Vector', 218 )
   end if
