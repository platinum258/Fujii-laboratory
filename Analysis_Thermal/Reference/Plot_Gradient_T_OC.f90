...
subroutine Plot_Gradient_T_OC  &
  ...
  integer :: Number_Line_X, Number_Line_Y
  !character(len=9) :: Structure='symmetry' 
  !character(len=9) :: Structure='asymmetry' 
  character(len=9) Structure 
  ...
  do e= 1, Number_Element
    do i= 1, 3
      if( Normal_Temperature_Lower_Side_Boundary > Value_OF_Element( i, e ) .or. &
        ...
        write(*,*)'e=', e, 'i=', i
        call Output_Error( 'Plot_Gradient_T_OC', 118 )
        write(*,*)'====================================================='
      end if
    end do
  end do
  ...
  if( Structure=='symmetry' )then
     ...
     call Output_Error( 'Plot_Gradient_T_OC', 558 )
  end if
  ...
  write(*,*) '     end subroutine Plot_Gradient_T_OC' 
  return
end subroutine Plot_Gradient_T_OC
