...
module Parameters  
   ...
   integer, parameter :: Flag_Thermal_Device= 30
   ! 0: Cloak
   ! 10: Carpet Cloak 
   ...
   integer, parameter :: Flag_RGB_Color= 5 ! 0
   ...
   integer, parameter :: Flag_Range_Value_Plot_Gradient= 1
      ...
      double precision, parameter :: Maximum_Value_Plotted_Diff= 1d-1
   ...
   double precision, parameter :: Radius_FixedDomain= Number_Grid_Scale_DesignDomain/3d0 
