...
subroutine Plot_OC_PV  &
   ...
   double precision :: Stemthick_Max, Stemthick_Min, Headthick_Max, Headthick_Min, Headlength_Max, Headlength_Min

   !================================================
   write(*,*)'      call Plot_OC_PV'
   !================================================
   ...
   if( Maximum_Value_Plotted < Minimum_Value_Plotted )then
      ...
      call Output_Error( 'Plot_OC_PV', 270 )
   end if
   ...
   if( Max_Number_Level_Element > Max_Number_Level_Element_Limit )then
     ...
     !go to 2272 
      ...
      !call Output_Error( 'Plot_OC_PV', 353 ) 
   end if
   ...
   if( Flag_Range_Value_Plot==0 )then
      ...
      do i= 1, Number_Node 
         if( Level_Node( i ) <= 0 )then
            ...
            write(*,*)'i=', i
            call Output_Error( 'Plot_OC_PV', 334 ) 
            ...
            write(*,*)'Value_Boundary_Level( 2, Number_Level )', Value_Boundary_Level( 2, Number_Level )
            write(*,*)'i=', i
            call Output_Error( 'Plot_OC_PV', 343 ) 
         end if
      end do
   end if
...
!                 Number_Level_Element, Number_Node_Level_Element, Position_Node_Plot_Mesh_Element, RGB, Level_Element )
      ...
      if( Number_Edge_Plot_Boundary==0 )then
         !call Output_Error( 'Plot_OC_PV', 2281 ) 
      end if
      ...
      do e= 1, Number_Edge_Plot_Boundary
         if( Class_Element( Element_Number_Plot_Boundary_tmp( e ) ) /= ID_Element_Structure )then 
            ...
            call Output_Error( 'Plot_OC_PV', 2298 ) 
         end if
      end do
      ...
      !Length_Maximum_Vector= Length_Maximum_Vector /( Position_Maximum( 1 ) -Position_Minimum( 1 ) )*dble( Width_PostScript( 1 ) )
      ...
      !   else
      !      call Output_Error( 'Plot_OC_PV', 2220 ) 
      !   end if
      ...
      Stemthick_Max= 0.5d0 ! Length_Maximum_Vector/20d0 
      Stemthick_Min= 0.1d0 !Length_Maximum_Vector/50d0 
      Headthick_Max= Length_Maximum_Vector_Position/10d0 
      Headthick_Min= Length_Maximum_Vector_Position/50d0 
      Headlength_Max= Length_Maximum_Vector_Position/10d0
      Headlength_Min= Length_Maximum_Vector_Position/50d0

      do e= 1, Number_PV
         Stemthick= ( Stemthick_Max -Stemthick_Min )*Level_PV( e ) +Stemthick_Min 
         Headthick= ( Headthick_Max -Headthick_Min )*Level_PV( e ) +Headthick_Min 
         Headlength= ( Headlength_Max -Headlength_Min )*Level_PV( e ) +Headlength_Min
      ...
      if( Flag_Polarization_Plot== 1 )then 
         write(*,*)' '
         write(*,*)'         ==> Electric_Field_and_Configuration_', Optimization_Step_Character, '.ps' 
      else if( Flag_Polarization_Plot== 2 )then 
         write(*,*)' '
         write(*,*)'         ==> Magnetic_Field_and_Configuration_', Optimization_Step_Character, '.ps' 
