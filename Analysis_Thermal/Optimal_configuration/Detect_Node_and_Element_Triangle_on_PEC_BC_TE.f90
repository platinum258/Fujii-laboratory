...
subroutine Detect_Node_and_Element_Triangle_on_PEC_BC_TE&
   ...
   !======================================================================================== 
   write(*,*)'         call Detect_Node_and_Element_Triangle_on_PEC_BC_TE'
   !======================================================================================== 
   ...
   do i= 1, Number_Node
      if( Flag_Node_PEC_BC( i ) < 0 .or. 3 < Flag_Node_PEC_BC( i ) )then
         ...
         call Output_Error( 'Detect_Node_and_Element_Triangle_on_PEC_BC_TE', 62 )
      end if
   end do
   ...
   !======================================================================================== 
   write(*,*)'         end Detect_Node_and_Element_Triangle_on_PEC_BC_TE'
   !======================================================================================== 

   return
end subroutine Detect_Node_and_Element_Triangle_on_PEC_BC_TE
