...
module Parameters  
   ...
   integer, parameter :: Flag_Thermal_Device= 10
   ! 0: Cloak
   ! 10: Carpet Cloak 
   ! 20: Cloak Concentrator
   integer, parameter :: Flag_Material_FixedDomain= 0 ! 0: off, 1: On
   ...
   integer, parameter :: Flag_RGB_Color_Diff= 0 
   ...
   integer, parameter :: Number_Grid_Y_Scattering= Number_Grid_Y_DesignDomain 
   ...
   double precision, parameter :: Position_Center_FixedDomain_Y= -Size_Y_Scattering
   double precision, parameter :: Position_Center_DesignDomain_X= Position_Center_FixedDomain_X 
   double precision, parameter :: Position_Center_DesignDomain_Y= Position_Center_FixedDomain_Y   
   ...
   !integer, parameter :: Number_Loop_DielectricConstant= 0
      ...
      double precision, parameter :: Normal_Thermal_Conductivity_Material= 67d0/386d0
      ...
      double precision, parameter :: Minimum_Position_Source_y= ( Size_Y_Scattering -Size_X_Scattering*0.1d0 )/Length_Characteristic
   ...
   = Position_Center_FixedDomain_Y_PS +Size_Y_Scattering/( 2d0*Size_Y_Scattering ) *dble( WidthPS_Y ) 
