...
subroutine Plot_Result_and_Configuration_Element_Triangle  &
           ( File_Number, &
   ...
   integer, intent(in) :: ID_Element_Structure
   ...
   !================================================
   write(*,*)'      call Plot_Result_and_Configuration_Element_Triangle'
   !================================================
   ...
   if( Maximum_Value_Plotted < Minimum_Value_Plotted )then
      ...
      call Output_Error( 'Plot_Result_and_Configuration_Element_Triangle', 270 )
   end if
   ...
   if( Max_Number_Level_Element > Max_Number_Level_Element_Limit )then
     ...
     !go to 2272 
      ...
      !call Output_Error( 'Plot_Result_and_Configuration_Element_Triangle', 353 ) 
   end if
   ...
   if( Flag_Range_Value_Plot==0 )then
      ...
      do i= 1, Number_Node 
         if( Level_Node( i ) <= 0 )then
            ...
            write(*,*)'i=', i
            call Output_Error( 'Plot_Result_and_Configuration_Element_Triangle', 334 ) 
            ...
            write(*,*)'Value_Boundary_Level( 2, Number_Level )', Value_Boundary_Level( 2, Number_Level )
            write(*,*)'i=', i
            call Output_Error( 'Plot_Result_and_Configuration_Element_Triangle', 343 ) 
         end if
      end do
   end if
   ...
   Filename_Result= trim( "Temperature_Distribution_and_Configuration_"//trim(Optimization_Step_Character)//".ps" )
      ...
      do e= 1, Number_Element
         ...
         !=======================================================================================
            ...
            if( Level_Node( Index_Element_2_Node( Local_Node_Number_Different_Level( e ), e ) ) &
               ...
               write(*,*)'Plot_Result_and_Configuration_Element_Triangle.f90 264'
               !stop
              !go to 2272
            end if
            ...
            do i= 1, Number_Node_Difference_Level( e )
               ...
               if( Difference_Position_1_Minus_NewPoint( 1, e )*Difference_Position_2_Minus_NewPoint( 1, e ) &
                  ...
                  write(287,*)' ' 
                  write(*,*)'Plot_Result_and_Configuration_Element_Triangle.f90 304' 
                  !stop
                 !go to 2272
               end if
            end do
            ...
            do i= 1, Number_Node_Difference_Level( e )
               ...
               if( Difference_Position_1_Minus_NewPoint( 1, e )*Difference_Position_2_Minus_NewPoint( 1, e ) &
                  ...
                  write(288,*)' ' 
                  write(*,*)'Plot_Result_and_Configuration_Element_Triangle.f90 381' 
                  !stop
                 !go to 2272
               end if
            end do
         ...
         !=======================================================================================
            ...
            if( Level_Node( Index_Element_2_Node( Local_Node_Number_Different_Level( e ), e ) ) & 
               ...
               write(*,*)'Level_Node( Index_Element_2_Node( Local_Node_Number_Edge_Line_Plot( 2, 2, e ), e ) )=', &
                      Level_Node( Index_Element_2_Node( Local_Node_Number_Edge_Line_Plot( 2, 2, e ), e ) ) 
               write(*,*)'Plot_Result_and_Configuration_Element_Triangle.f90 448'
               !stop
              !go to 2272
            end if
            ...
            do i= 1, Number_Node_Difference_Level( e )
               ...
               if( Difference_Position_1_Minus_NewPoint( 1, e )*Difference_Position_2_Minus_NewPoint( 1, e ) &
                  ...
                  write(287,*)'=====' 
                  write(287,*)' ' 
                  write(*,*)'Plot_Result_and_Configuration_Element_Triangle.f90 509' 
                  !stop
                 !go to 2272
               end if
            end do
            ...
            do i= 1, Number_Node_Difference_Level( e )
               ...
               if( Difference_Position_1_Minus_NewPoint( 1, e )*Difference_Position_2_Minus_NewPoint( 1, e ) &
                  ...
                  write(288,*)' ' 
                  write(*,*)'Plot_Result_and_Configuration_Element_Triangle.f90 573' 
                  !stop
                 !go to 2272
               end if
            end do
...
!                 Number_Level_Element, Number_Node_Level_Element, Position_Node_Plot_Mesh_Element, RGB, Level_Element )
         ...
         !=======================================================================================
            ...
            if( Level_Node( Index_Element_2_Node( Local_Node_Number_Different_Level( e ), e ) ) &
               ...
               write(*,*)'Level_Node( Index_Element_2_Node( Local_Node_Number_Edge_Line_Plot( 2, 2, e ), e ) )=', &
                      Level_Node( Index_Element_2_Node( Local_Node_Number_Edge_Line_Plot( 2, 2, e ), e ) ) 
               write(*,*)'Plot_Result_and_Configuration_Element_Triangle.f90 634'
               !stop
              !go to 2272
            end if
            ...
            do i= 1, Number_Node_Difference_Level( e )
               ...
               if( Difference_Position_1_Minus_NewPoint( 1, e )*Difference_Position_2_Minus_NewPoint( 1, e ) &
                  ...
                  write(287,*)' ' 
                  write(*,*)'Plot_Result_and_Configuration_Element_Triangle.f90 702' 
                  !stop
                 !go to 2272
               end if
            end do
            ...
            do i= 1, Number_Node_Difference_Level( e )
               ...
               if( Difference_Position_1_Minus_NewPoint( 1, e )*Difference_Position_2_Minus_NewPoint( 1, e ) &
                  ...
                  write(288,*)' ' 
                  write(*,*)'Plot_Result_and_Configuration_Element_Triangle.f90 763' 
                  !stop
                 !go to 2272
               end if
            end do
         ...
         !=======================================================================================
            ...
            do i= 1, Number_Node_Difference_Level( e )
               ...
               if( Difference_Position_1_Minus_NewPoint( 1, e )*Difference_Position_2_Minus_NewPoint( 1, e ) & 
                  ...
                  write(287,*)' ' 
                  write(*,*)'Plot_Result_and_Configuration_Element_Triangle.f90 888' 
                  !stop
                 !go to 2272
               end if
            end do
            ...
            do i= 1, Number_Node_Difference_Level( e )
               ...
               if( Difference_Position_1_Minus_NewPoint( 1, e )*Difference_Position_2_Minus_NewPoint( 1, e ) &
                  ...
                  write(288,*)' ' 
                  write(*,*)'Plot_Result_and_Configuration_Element_Triangle.f90 949' 
                  !stop
                 !go to 2272
               end if
            end do
...
!                 Number_Level_Element, Number_Node_Level_Element, Position_Node_Plot_Mesh_Element, RGB, Level_Element )
         ...
         !=======================================================================================
            ...
            if( Level_Node( Index_Element_2_Node( Local_Node_Number_Different_Level( e ), e ) ) &
               ...
               write(*,*)'Level_Node( Index_Element_2_Node( Local_Node_Number_Edge_Line_Plot( 2, 2, e ), e ) )=', &
                      Level_Node( Index_Element_2_Node( Local_Node_Number_Edge_Line_Plot( 2, 2, e ), e ) ) 
               write(*,*)'Plot_Result_and_Configuration_Element_Triangle.f90 826'
               !stop
              !go to 2272
            end if
            ...
            do i= 1, Number_Node_Difference_Level( e )
               ...
               if( Difference_Position_1_Minus_NewPoint( 1, e )*Difference_Position_2_Minus_NewPoint( 1, e ) &
                  ...
                  write(287,*)' ' 
                  write(*,*)'Plot_Result_and_Configuration_Element_Triangle.f90 1073' 
                  !stop
                 !go to 2272
               end if
            end do
            ...
            do i= 1, Number_Node_Difference_Level( e )
               ...
               if( Difference_Position_1_Minus_NewPoint( 1, e )*Difference_Position_2_Minus_NewPoint( 1, e ) &
                  ...
                  write(288,*)' ' 
                  write(*,*)'Plot_Result_and_Configuration_Element_Triangle.f90 1134' 
                  !stop
                 !go to 2272
               end if
            end do
         ...
         !=======================================================================================
            ...
            do i= 1, Number_Node_Difference_Level( e )
               ...
               if( Difference_Position_1_Minus_NewPoint( 1, e )*Difference_Position_2_Minus_NewPoint( 1, e ) &
                  ...
                  write(287,*)' ' 
                  write(*,*)'Plot_Result_and_Configuration_Element_Triangle.f90 1259' 
                  !stop
                 !go to 2272
               end if
            end do
            ...
            do i= 1, Number_Node_Difference_Level( e )
               ...
               if( Difference_Position_1_Minus_NewPoint( 1, e )*Difference_Position_2_Minus_NewPoint( 1, e ) &
                  ...
                  write(288,*)' ' 
                  write(*,*)'Plot_Result_and_Configuration_Element_Triangle.f90 1320' 
                  !stop
                 !go to 2272
               end if
            end do
...
!                 Number_Level_Element, Number_Node_Level_Element, Position_Node_Plot_Mesh_Element, RGB, Level_Element )
      ...
      if( Number_Edge_Plot_Boundary==0 )then
         !call Output_Error( 'Plot_Result_and_Configuration_Element_Triangle', 2281 ) 
      end if
      ...
      do e= 1, Number_Edge_Plot_Boundary
         if( Class_Element( Element_Number_Plot_Boundary_tmp( e ) ) /= ID_Element_Structure )then 
            ...
            call Output_Error( 'Plot_Result_and_Configuration_Element_Triangle', 2298 ) 
         end if
      end do
      ...
      do e= 1, Number_Element
         ...
         if( Flag_Plot_Element( e )==3 )then
            ...
            call Output_Error( 'Plot_Result_and_Configuration_Element_Triangle', 2220 ) 
         end if
      ...
      write(*,*)' '
      write(*,*)'         ==> Temperature_Distribution_and_Configuration_', Optimization_Step_Character, '.ps' 
   ...
   return
end subroutine Plot_Result_and_Configuration_Element_Triangle
