...
subroutine Check_DMUMPS_Format( aa_zmumps, ia_zmumps, ja_zmumps, Number_Node, Number_NonZero, Flag_Symmetric, Flag_Matrix_Upper )
   ...
   double precision, intent(in) :: aa_zmumps( Number_NonZero )
   ...
   do i= 1, Number_NonZero
      if( aa_zmumps( i )==Zero )then
         ...
         !call Output_Error( 'Check_DMUMPS_Format', 21 )
      end if
      ...
      if( ia_zmumps( i ) > Number_Node .or. ia_zmumps( i ) <= 0 )then
         ...
         call Output_Error( 'Check_DMUMPS_Format', 33 )
      end if
      ...
      if( ja_zmumps( i ) > Number_Node .or. ja_zmumps( i ) <= 0 )then
         ...
         write(*,*)'ja_zmumps( i )=', ja_zmumps( i )
         write(*,*)'Number_Node=', Number_Node
         call Output_Error( 'Check_DMUMPS_Format', 42 )
      end if
      ...
      if( ia_zmumps( i ) < ja_zmumps( i ) .and. Flag_Symmetric==Flag_On .and. Flag_Matrix_Upper==Flag_Off )then
         ...
         call Output_Error( 'Check_DMUMPS_Format', 61 )
      end if
      ...
      if( ia_zmumps( i ) > ja_zmumps( i ) .and. Flag_Symmetric==Flag_On .and. Flag_Matrix_Upper==Flag_On )then
         ...
         write(*,*)'Flag_Symmetric=', Flag_Symmetric
         write(*,*)'Flag_Matrix_Upper=', Flag_Matrix_Upper
         call Output_Error( 'Check_DMUMPS_Format', 75 )
      end if
   ...
   if( I_Max_AVM/=Number_Node )then
      ...
      write(*,*)'Number_Node=', Number_Node
      call Output_Error( 'Check_DMUMPS_Format', 63 )
   end if 
   ...
   if( J_Max_AVM/=Number_Node )then
      ...
      write(*,*)'Number_Node=', Number_Node
      call Output_Error( 'Check_DMUMPS_Format', 71 )
   end if
   ...
   if( I_Min_AVM/=1 )then
      ...
      write(*,*)'Number_Node=', Number_Node
      call Output_Error( 'Check_DMUMPS_Format', 88 )
   end if 
   ...
   if( J_Min_AVM/=1 )then
      ...
      write(*,*)'Number_Node=', Number_Node
      call Output_Error( 'Check_DMUMPS_Format', 95 )
   end if
   ...
   return
end subroutine Check_DMUMPS_Format
