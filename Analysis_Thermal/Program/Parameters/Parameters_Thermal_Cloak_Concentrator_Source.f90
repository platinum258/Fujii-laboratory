...
module Parameters  
   ...
   integer, parameter :: Flag_Thermal_Device= 21
   ! 0: Cloak
   ! 10: Carpet Cloak 
   ! 20: Cloak Concentrator
   integer, parameter :: Flag_Material_FixedDomain= 2 ! 0: off, 1: filled with Base Material 2: filled with Open region material
   integer, parameter :: Number_Objective_Function= 2
   ...
   integer, parameter :: Flag_RGB_Color= 9! 0
   ...
   integer, parameter :: Number_Grid_Scale_DesignDomain= 60
   ...
   double precision, parameter :: Radius_FixedDomain= Number_Grid_Scale_DesignDomain/10d0 
   ...
   !integer, parameter :: Number_Loop_DielectricConstant= 0
      double precision, parameter :: Minimum_Thermal_Conductivity= 1.0d0 !0.15d0/67d0
      double precision, parameter :: Maximum_Thermal_Conductivity= 386d0/67d0
      double precision, parameter :: Normal_Thermal_Conductivity_Material= 0.15d0/67d0 
      !double precision, parameter :: Normal_Thermal_Conductivity_Material= 1.0d0 !0.15d0/67d0 

      double precision, parameter :: Thermal_Conductivity_Base_Material= 386d0/67d0
      ...
      double precision, parameter :: Thermal_Conductivity_FixedDomain= Thermal_Conductivity_OpenRegion 
  
      double precision, parameter :: Minimum_Position_Source_x= -Size_X_Scattering*0.9d0/Length_Characteristic
      double precision, parameter :: Maximum_Position_Source_x= 0.0d0
      double precision, parameter :: Normal_Position_Source_x= -Size_X_Scattering*0.9d0/Length_Characteristic

      double precision, parameter :: Minimum_Position_Source_y= 0.0d0 
      double precision, parameter :: Maximum_Position_Source_y= ( Size_Y_Scattering -Size_X_Scattering*0.1d0 )/Length_Characteristic
      !double precision, parameter :: Normal_Position_Source_y= ( Size_Y_Scattering -Size_X_Scattering*0.1d0 )/Length_Characteristic
      double precision, parameter :: Normal_Position_Source_y= 0.0d0 
