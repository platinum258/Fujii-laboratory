...
!============================================================================================
 ...
 if(process_id==0) then
      call cmaes(design_variable,Convergence_Ratio,&
                 'min', Type_CMA,Optimization_Step,Number_Design_Variable, lambda, 0.0d0, 1.5d0, fitness&
          ...
          write(iw,*)'0.0 setgray'
           do e=1,Number_Element
             if(eid(e)==4) then
               ...
               write(iw,*) 'closepath'
               write(iw,*) 1.0d0-(Best_sample_lambda_va(e)-1.0d0)/1.5d0,'setgray'
               write(iw,*) 'fill'
               write(iw,*) ''
             end if
           end do    
        ...
        write(iw,*)'0.0 setgray'
         do e=1,Number_Element
           if(eid(e)==4) then
             ...
             (450.0d0/dble(nely))*position_in_element(e,3,2)+225.0d0, 'lineto'
             write(iw,*) 'closepath'
             write(iw,*) 1.0d0-Density_plot(e)/1.5d0,'setgray'
             write(iw,*) 'fill'
             write(iw,*) ''
           end if
         end do    
