...
!debug
!iw=302
! open(iw,file='T_bare.txt',status='new')
!   do i=1,Number_Node
!   write(iw,*) xcoord(i), ycoord(i), T_bare(i)
!   end do
! close(iw)
!debug
...
!============================================================================================
  ...
  do while(Convergence_Ratio_dowhile>Convergence_Error)
   ...
   do sample=1,lambda!while(change>1.0d-2)
...
!============================================================================================
    ...
    write(*,*)'Making Global Matrix'
    !===================================================================================
    call mkGSM(ND,Number_Element,Number_Node,Number_Sampling,lambda_va,eid,l_matrix,NODEX,XCOORD,YCOORD,g_matrix,sample)
    !=================================================================================== 
    write(*,*)'Set boundary conditions'
    !===================================================================================
    call setBC(Number_Element,Number_Node,nd,Number_Node_for_fem,xcoord,ycoord,g_matrix,T_rhs,mnx,mxx,mny,mxy )
