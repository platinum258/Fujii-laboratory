...
! integer,parameter :: Number_Node=nelx*nely*2
   ...
   integer,parameter :: Number_sampling=60
   ...
   !compute objective function
    ...
    open(iw,file=filename,status='replace')
       ...
       write(iw,*)'0.0 setgray'
        do e=1,Number_Element
        if(eid(e)==4) then
          write(iw,*) 5.0d0*position_in_element(e,1,1)+300.0d0,5.0d0*position_in_element(e,1,2)+200.0d0, 'm'
          write(iw,*) 5.0d0*position_in_element(e,2,1)+300.0d0,5.0d0*position_in_element(e,2,2)+200.0d0, 'l'
          write(iw,*) 5.0d0*position_in_element(e,3,1)+300.0d0,5.0d0*position_in_element(e,3,2)+200.0d0, 'l'
          write(iw,*) 'closepath'
